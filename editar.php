...
$id = $_GET["id"];
$sentencia = $mysqli->prepare("SELECT id, nombre, descripcion, cantidad FROM videojuegos WHERE id = ?");
    ...
    <div class="col-12">
        ...
        <form action="actualizar.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input value="<?php echo $videojuego["cantidad"] ?>" placeholder="Cantidad" class="form-control" type="number" name="cantidad" id="cantidad" required>
            </div>
            <div class="form-group">
